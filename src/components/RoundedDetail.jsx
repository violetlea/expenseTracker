export default function RoundedDetail(props) {
	...
	return (
		<>
			<div className="rounded-lg border-2  border-[#4F3E5E] bg-[#EDEDE8] p-2 grid grid-cols-7">
				<div className="col-span-6 flex items-center justify-start">
					<p key={index} className="textDefault text-xs md:text-base text-wrap">
						{text}
					</p>
				</div>
